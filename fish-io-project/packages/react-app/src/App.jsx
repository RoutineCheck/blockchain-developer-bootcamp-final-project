...
function onClick() {
  ...
  const yourLocalBalance = useBalance(localProvider, address);App
      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route path="/ipfsdown">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                setDownloading(true);
                setIpfsContent();
                const result = await getFromIPFS(ipfsDownHash); // addToIPFS(JSON.stringify(yourJSON))2
          ...
          <Route path="/game">
            ...
            {!hidden2 && <div className="iFrame">
      <Iframe src="https://fishio-app.herokuapp.com/?"
       position="absolute"
	width="100%"
	id="myId"
